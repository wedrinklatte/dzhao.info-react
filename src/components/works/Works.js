...
import SpecialWorkItem from './SpecialWorkItem';
      ...
      <section className="module" id="works-section">
				<div className="container">
					...
					<ul id="works-grid" className="works-grid works-grid-4 works-grid-masonry works-hover-w">
						<WorkItem name="spotlight" title="Spotlight" avatar={spotlight} category="data web" 
						...
						<WorkItem name="dashboard" title="Dashboard Lightweight Booting" avatar={dashboard} category="data network" 
							subtitle="A comprehensive analyzer to gauge market sentiment and to identify key ETF trends."
							...
							\nI helped with the web GUI part as well, where we visualized the multi dimension results and make the tool interactive. We used AngularJS as the web framework and Highcharts as the primary UI components.
							\nSpotlight won the Global Retail Tech business bounty champion." />
						<WorkItem name="btap" title="Text Analytics On Demand" avatar={btap} category="data web network" 
						...
						<WorkItem name="bigml" title="Big Machine Learning" avatar={bigml} category="data" 
						...
						<WorkItem name="fxrate" title="FX Rate Prediction" avatar={fxrate} category="data" 
							...
							"/>
						<WorkItem name="waterchat" title="WaterChat" avatar={waterchat} category="mobile network" 
							...
							"/>
						<WorkItem name="pmc" title="PUBMED CENTRAL TOPIC VISUALIZATION" avatar={pmc} category="data" 
							...
							"/>
						<WorkItem name="searchengine" title="SEARCH ENGINE" avatar={searchengine} category="data" 
							...
							"/>
						<SpecialWorkItem name="woodie" title="ADVENTURER WOODIE" avatar={mobilegame} fullimg={woodie} category="mobile" 
							...
							"/>
						<WorkItem name="aws" title="CLOUD COMPUTING WITH AWS" avatar={aws} category="data network" 
							...
							"/>
						<WorkItem name="cloudlol" title="CLOUDLOL" avatar={cloudlol} category="data network" 
							...
							"/>
						<WorkItem name="attendance" title="VOICE INTELLIGENT ATTENDANCE SYSTEM" avatar={attendance} category="data mobile network" 
